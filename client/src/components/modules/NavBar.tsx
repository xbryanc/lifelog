...
import { NAVBAR_HAMBURGER_WIDTH_THRESHOLD } from "../../../../defaults";
...
export default class NavBar extends React.Component {
  ...
  render() {
    ...
    if (this.state.width <= NAVBAR_HAMBURGER_WIDTH_THRESHOLD) {
      return (
            ...
            >
              <Link
                ...
                className={classNames("nav-item", "nav-link", {
                  "nav-current": this.state.path.startsWith("/home"),
                })}
              >
                Home
              </Link>
              <div className="nav-item dropdown">
                <img
                  className={classNames(
                    "nav-link dropdown-toggle profileIcon",
                    { "nav-current": this.state.path.startsWith("/profile") }
                  )}
                  id="navbarDropdown"
                  role="button"
